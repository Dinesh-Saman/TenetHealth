  ...
  const handleDownload = () => {
    ...
    img.onload = function() {
        ...
        for (let i = 1; i <= pageCount; i++) {
            ...
            // Add "Report Generated On" footer
            doc.text(`Report Generated On: ${today}`, margin, doc.internal.pageSize.getHeight() - 10, { align: 'left' });
        }
    ...
    <Box>
      <Box display="flex">
        ...
        >
          ...
          <Box mt={4}>
            <Button variant="contained" color="primary" onClick={handleDownload} style={{marginBottom:'15px'}}>
              Download PDF
            </Button>
          </Box>
