...
const ViewInventory = () => {
  ...
  const generateReport = () => {
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      // Add "Report generated on" with the current date at the bottom-left of the page
      doc.text(`Report generated on: ${today}`, 14, doc.internal.pageSize.getHeight() - 10);
      
      // Optionally, you can add page numbers if needed
