...
// Controller to update user profile by username
exports.updateUserProfile = async (req, res) => {
  const { username } = req.params;
  const { title, firstName, lastName, address, NIC, DOB, contact, emailAddress, city, district } = req.body;

  try {
    const updatedUser = await User.findOneAndUpdate(
      { username },
      { title, firstName, lastName, address, NIC, DOB, contact, emailAddress, city, district },
